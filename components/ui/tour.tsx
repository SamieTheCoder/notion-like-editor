    ...
    <Portal>
      ...
      <TourPositioner>
        ...
        >
          ...
          {!!showCloseButton && (
            <TourClose asChild className="absolute top-4 right-4"><Button className="size-8 border-none opacity-70 hover:opacity-100" size="icon-sm" variant="ghost"><X /><span className="sr-only">Close</span></Button></TourClose>
          )}
        </ArkTour.Content>
      </TourPositioner>
...
export const TourFooter = (
  ...
  return (
    <ArkTour.Control {...rest} asChild><DialogFooter data-slot="tour-control">{children}</DialogFooter></ArkTour.Control>
  );
};
...
export const TourPreviousStep = (
  ...
  return (
    <TourActionTrigger data-slot="tour-previous-step" {...rest} action={prevAction} asChild><Button size="sm" variant="outline"><ChevronLeft />{prevAction.label}</Button></TourActionTrigger>
  );
};
...
export const TourNextStep = (
  ...
  return (
    <TourActionTrigger data-slot="tour-next-step" {...rest} action={action} asChild><Button size="sm">{action.label}{actionType === "next" && <ChevronRight />}</Button></TourActionTrigger>
  );
};
